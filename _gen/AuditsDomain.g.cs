...
public sealed class AuditsDomain(CdpModule cdp) : global::Selenium.WebDriver.BiDi.Cdp.Domain(cdp)
{
    ...
    /// Optional parameters (via <paramref name="options"/>):
    /// <list type="bullet">
    /// <item><description><b>ReportAAA</b> - Whether to report WCAG AAA level issues. Default is false.</description></item>
    /// </list>
    /// </remarks>
    /// <param name="options">
    /// Optional parameters. See <see cref="CheckContrastCommandOptions"/>.
    /// </param>
    /// <param name="cancellationToken">
    /// A token to cancel the asynchronous operation.
    /// </param>
    /// <returns>
    /// A task representing the asynchronous operation, containing a <see cref="CheckContrastResult"/>.
    /// </returns>
    public async Task<CheckContrastResult> CheckContrastAsync(CheckContrastCommandOptions? options = default, CancellationToken cancellationToken = default)
    {
        var @params = new CheckContrastCommandParameters(ReportAAA: options?.ReportAAA);
        return await ExecuteCommandAsync(CheckContrastCommand, @params, options, cancellationToken).ConfigureAwait(false);
    }
    private static readonly CdpCommand<CheckContrastCommandParameters, CheckContrastResult> CheckContrastCommand = new("Audits.checkContrast", JsonContext.CheckContrastCommandParameters, JsonContext.CheckContrastResult);
...
internal sealed record CheckContrastCommandParameters(bool? ReportAAA) : Parameters;

/// <summary>
/// Optional parameters for <see cref="AuditsDomain.CheckContrastAsync"/>.
/// </summary>
public sealed record CheckContrastCommandOptions : CdpCommandOptions
{
    /// <summary>
    /// Whether to report WCAG AAA level issues. Default is false.
    /// </summary>
    public bool? ReportAAA { get; init; }
}

/// <summary>
/// </summary>
public sealed record CheckContrastResult() : EmptyResult;
...
public enum CookieExclusionReason
{
    ...
    /// <summary>
    /// </summary>
    [global::System.Text.Json.Serialization.JsonStringEnumMemberName("ExcludeInvalidSameParty")]
    ExcludeInvalidSameParty,
    /// <summary>
    /// </summary>
    [global::System.Text.Json.Serialization.JsonStringEnumMemberName("ExcludeSamePartyCrossPartyContext")]
...
/// </param>
/// <param name="ViolatingNodeSelector">
/// </param>
/// <param name="ContrastRatio">
/// </param>
/// <param name="ThresholdAA">
/// </param>
/// <param name="ThresholdAAA">
/// </param>
/// <param name="FontSize">
/// </param>
/// <param name="FontWeight">
/// </param>
public sealed record LowTextContrastIssueDetails(DOM.BackendNodeId ViolatingNodeId, string ViolatingNodeSelector, double ContrastRatio, double ThresholdAA, double ThresholdAAA, string FontSize, string FontWeight)
{
}
...
public enum GenericIssueErrorType
{
    ...
    /// <summary>
    /// </summary>
    [global::System.Text.Json.Serialization.JsonStringEnumMemberName("FormAriaLabelledByToNonExistingId")]
    ...
    /// <summary>
    /// </summary>
    [global::System.Text.Json.Serialization.JsonStringEnumMemberName("FormLabelHasNeitherForNorNestedInput")]
...
public enum FederatedAuthRequestIssueReason
{
    ...
    /// <summary>
    /// </summary>
    [global::System.Text.Json.Serialization.JsonStringEnumMemberName("ClientMetadataHttpNotFound")]
    ClientMetadataHttpNotFound,
    /// <summary>
    /// </summary>
    [global::System.Text.Json.Serialization.JsonStringEnumMemberName("ClientMetadataNoResponse")]
    ClientMetadataNoResponse,
    /// <summary>
    /// </summary>
    [global::System.Text.Json.Serialization.JsonStringEnumMemberName("ClientMetadataInvalidResponse")]
    ClientMetadataInvalidResponse,
    /// <summary>
    /// </summary>
    [global::System.Text.Json.Serialization.JsonStringEnumMemberName("ClientMetadataInvalidContentType")]
    ...
    /// <summary>
    /// </summary>
    [global::System.Text.Json.Serialization.JsonStringEnumMemberName("ThirdPartyCookiesBlocked")]
    ...
    /// <summary>
    /// </summary>
    [global::System.Text.Json.Serialization.JsonStringEnumMemberName("InvalidFieldsSpecified")]
...
public enum InspectorIssueCode
{
    ...
    /// <summary>
    /// </summary>
    [global::System.Text.Json.Serialization.JsonStringEnumMemberName("LowTextContrastIssue")]
...
public sealed record InspectorIssueDetails()
{
    ...
    /// <summary>
    /// </summary>
    public LowTextContrastIssueDetails? LowTextContrastIssueDetails { get; init; }
...
[JsonSerializable(typeof(CheckContrastCommandParameters), TypeInfoPropertyName = "CheckContrastCommandParameters")]
[JsonSerializable(typeof(CheckContrastResult), TypeInfoPropertyName = "CheckContrastResult")]
...
[JsonSerializable(typeof(LowTextContrastIssueDetails), TypeInfoPropertyName = "AuditsLowTextContrastIssueDetails")]
